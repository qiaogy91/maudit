...
type Event struct {
	...
	// @gotags: validate:"required"
	Agent string `protobuf:"bytes,5,opt,name=agent,proto3" json:"agent,omitempty" validate:"required"`
	// @gotags: validate:"required"
	Service string `protobuf:"bytes,6,opt,name=service,proto3" json:"service,omitempty" validate:"required"`
	// @gotags: validate:"required"
	Resource string `protobuf:"bytes,7,opt,name=resource,proto3" json:"resource,omitempty" validate:"required"`
	// @gotags: validate:"required"
	Action string `protobuf:"bytes,8,opt,name=action,proto3" json:"action,omitempty" validate:"required"`
	// @gotags: validate:"required"
	ResponseCode int64 `protobuf:"varint,9,opt,name=response_code,json=responseCode,proto3" json:"response_code,omitempty" validate:"required"`
}
...
var file_apps_event_pb_model_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x74, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xe0, 0x01, 0x0a, 0x05, 0x45, 0x76,
	...
	0x72, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01,
	...
	0x6e, 0x73, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c,
