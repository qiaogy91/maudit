...
type Event struct {
	...
	// @gotags: validate:"required"
	User string `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty" validate:"required"`
	// @gotags: validate:"required"
	Source string `protobuf:"bytes,3,opt,name=source,proto3" json:"source,omitempty" validate:"required"`
	// @gotags: validate:"required"
	Agent string `protobuf:"bytes,4,opt,name=agent,proto3" json:"agent,omitempty" validate:"required"`
	// @gotags: validate:"required"
	Service string `protobuf:"bytes,5,opt,name=service,proto3" json:"service,omitempty" validate:"required"`
	// @gotags: validate:"required"
	Resource string `protobuf:"bytes,6,opt,name=resource,proto3" json:"resource,omitempty" validate:"required"`
	// @gotags: validate:"required"
	Action string `protobuf:"bytes,7,opt,name=action,proto3" json:"action,omitempty" validate:"required"`
	// @gotags: validate:"required"
	ResponseCode int64 `protobuf:"varint,8,opt,name=response_code,json=responseCode,proto3" json:"response_code,omitempty" validate:"required"`
}
...
var file_apps_event_pb_model_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x74, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xd0, 0x01, 0x0a, 0x05, 0x45, 0x76,
	...
	0x72, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x65, 0x72,
	...
	0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c,
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x4b, 0x0a, 0x08,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61,
	...
	0x6d, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x71, 0x69, 0x61, 0x6f, 0x67, 0x79, 0x39, 0x31,
	0x2f, 0x6d, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x65, 0x76, 0x65,
